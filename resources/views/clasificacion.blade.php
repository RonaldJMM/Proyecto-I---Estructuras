		...
		<div class="container-fluid">
			...
			<div class="container">
			  <div class="row">
			    ...
			    <div class="col"><h1>Clasificación</h1></div>
			    
			    <div class="w-100"></div>
			    <div class="col">
			    	<blockquote class="blockquote">
					  <p class="mb-0"><div class="container">
						  <div class="row">
						    <div class="col-sm">
						      <b>Medios Primarios</b><br><br>
						      Son todos aquellos que no estan conformados por maquinas, como la voz humana.<br><br>
						      <img src="Imagenes/fondos/voz.png" class="rounded mx-auto d-block" alt="20%">
						    </div>
						    <div class="col-sm">
						       <b>Medios Secundarios</b><br><br>
						      Son todos aquellos que estan conformados por el uso de medios tecnicos, como el periodico.<br><br>
						      <img src="Imagenes/fondos/periodico.png" class="rounded mx-auto d-block" alt="20%">
						    </div>
						    <div class="col-sm">
						       <b>Medios Terciarios</b><br><br>
						      Son todos aquellos que estan conformados por maquinas, como la radio.<br><br>
						      <img src="Imagenes/fondos/microfono.png" class="rounded mx-auto d-block" alt="20%">
						    </div>
						  </div>
						</div>
						</p>
